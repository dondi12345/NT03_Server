...
exports.UpdateUserPlayer = exports.FindByIdAccountAndServerGameCode = exports.CreateUserPlayer = exports.GetUserPlayerById = exports.UserPlayerModel = exports.UserPlayer = exports.UserPlayerWithToken = exports.UserPlayerSocket = void 0;
...
class UserPlayerSocket {
}
exports.UserPlayerSocket = UserPlayerSocket;
class UserPlayerWithToken {
}
exports.UserPlayerWithToken = UserPlayerWithToken;
class UserPlayer {
    constructor() {
        this._id = new mongoose_1.Types.ObjectId();
        this.PlayerName = "Player" + (10000 + Math.floor(Math.random() * 90000));
        this.Wave = 0;
    }
...
function CreateUserPlayer(userPlayer) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield exports.UserPlayerModel.create(userPlayer).then(res => {
            ...
            (0, LogController_1.LogServer)(LogCode_1.LogCode.UserPlayerServer_CreateFail, err, LogModel_1.LogType.Error);
        });
