...
function InitWithSocket() {
    ...
    const io = new socket_io_1.Server(Env_1.port.portChatServer);
    console.log(`Dev 1684563910 Worker ${process.pid} listening to ChatServer on port: ${Env_1.port.portChatServer}`);
