...
function ResLogin(message, userSocket) {
    return __awaiter(this, void 0, void 0, function* () {
        yield (0, Res_1.FindResByIdUserPlayer)(userSocket.IdUserPlayer).then((respone) => __awaiter(this, void 0, void 0, function* () {
            ...
            (0, LogController_1.LogUserSocket)(LogCode_1.LogCode.Res_LoginSuccess, userSocket, "", LogModel_1.LogType.Normal);
        })).catch(e => {
            (0, LogController_1.LogUserSocket)(LogCode_1.LogCode.Res_LoginFail, userSocket, e, LogModel_1.LogType.Error);
            var message = new Message_1.Message();
...
function CreateNewRes(resCode, userSocket) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield (0, Res_1.CreateRes)(res).then(respone => {
            ...
            (0, LogController_1.LogUserSocket)(LogCode_1.LogCode.Res_CreateNewFail, userSocket, e, LogModel_1.LogType.Error);
