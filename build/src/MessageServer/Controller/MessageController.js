...
function Connect(message, userSocket) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (data == null || data == undefined) {
            ...
            (0, LogController_1.LogUserSocket)(LogCode_1.LogCode.MessageServer_TokenAuthenFail, userSocket, "", LogModel_1.LogType.Warning);
            return;
        }
        else {
            ...
            if (accountData.IdDevice != tockenAuthen.IdDevice) {
                ...
                (0, LogController_1.LogUserSocket)(LogCode_1.LogCode.MessageServer_WrongDevice, userSocket, "", LogModel_1.LogType.Warning);
            ...
            (0, LogController_1.LogUserSocket)(LogCode_1.LogCode.MessageServer_TokenAuthenSuccess, userSocket, "", LogModel_1.LogType.Normal);
