    ...
    InitData(dataName) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield DataVersion_1.DataVersionModel.findOne({
                ...
                var dataVersionCache = new DataVersion_1.DataVersion();
                ...
                RedisConnect_1.redisControler.Set(Env_1.RedisKeyConfig.KeyDataCenterDetail(dataName), JSON.stringify(dataVersionCache));
